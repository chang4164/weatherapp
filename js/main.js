$(document).ready(function(){
  ...
  function w_info(){
    ...
    $("#weather li").each(function(index){
      ...
      $.ajax({
        url : `https://api.openweathermap.org/data/2.5/weather?q=${cityName[index]}&appid=b13d7c3804797f83684864a8ae290b9f`,
        dataType : "json",
  ...
  navigator.geolocation.getCurrentPosition(function(position){
    ...
    $.ajax({
      url : `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longtitude}&appid=b13d7c3804797f83684864a8ae290b9f`,
      dataType : "json",
      success : function(data){
        //console.log(data);
        const city = data.name;
